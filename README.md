...
* [Pebblecoin Github](https://github.com/xpbcreator/pebblecoin)
* IRC (freenode)
  * Join #pebblecoin: https://webchat.freenode.net/?channels=#pebblecoin


#### Pools Using This Software

* http://pool.pebblecoin.io
...
```bash
git clone https://github.com/xpbcreator/pebblepool.git pool
cd pool
npm update
```
...
*Warning for Boulderhash coins other than Pebblecoin:* this software may or may not work with any given cryptonote coin.
    ...
    "ports": [
        {
            ...
            "difficulty": 5, //Initial difficulty miners are set to
...
"payments": {
    ...
    "transferFee": 10000000, //fee to pay for each transaction
    "minPayment": 1000000000, //miner balance required before sending payment
    "maxPayment": 20000000000, //max payment at once to prevent too-large transactions
...
"blockUnlocker": {
    ...
    "depth": 60,
    "poolFee": 2.0, //1.8% pool fee (2% total fee total including donations)
},
...
#### 3) [Optional] Configure pebblecoin-easy-miner for your pool
Your miners that are Windows users can use [pebblecoin-easy-miner](https://github.com/xpbcreator/pebblecoin-easy-miner)
...
/* Minimum units in a single coin, for Pebblecoin its 100000000. */
var coinUnits = 100000000;

/* Pool server host to instruct your miners to point to.  */
var poolHost = "pool.pebblecoin.io";

/* IRC Server and room used for embedded KiwiIRC chat. */
var irc = "irc.freenode.net/#pebblecoin";

/* Contact email address. */
var email = "xpbcreator@mac.hush.com";

/* Market stat display params from https://www.cryptonator.com/widget */
var cryptonatorWidget = [];

/* Download link to cryptonote-easy-miner for Windows users. */
var easyminerDownload = "https://github.com/xpbcreator/pebblecoin-easy-miner/releases/";

/* Used for front-end block links. For other coins it can be changed, for example with
   Pebblecoin it doesn't exist. */
...
* XPB: `PByFqCfuDRUPVsNrzrUXnuUdF7LpXsTTZXeq5cdHpJDogbJ8EBXopciN7DmQiGhLEo5ArA7dFqGga2AAhbRaZ2gL8jjp9VmYgk`

Credits
===

* [xpbcreator](//github.com/xpbcreator) - Modified the pool to work for pebblecoin
